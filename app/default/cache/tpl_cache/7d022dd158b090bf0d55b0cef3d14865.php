...
<meta name="generator" content="91mb 5.3.16"  data-variable="http://show.91mb.com.cn/muban/res013/323/,cn,108,,2,res013" />
...
<link rel='stylesheet' href='/public/default/css/page.css'>
</head>
<body>
<!--[if lte IE 8]>
...
<section class="met-news animsition ">
    <div class="container">
						...
						<li class="">
							<div class="media media-lg">
								<div class="media-left">
									<a href="<?php echo $this->url('blog/blog_news',['id'=>$v['id']]);?>" title="O<?php echo $v['title']; ?>" target='_self'>
										<img class="media-object" src="<?php echo $v['image']; ?>" style='height:150px;' alt="<?php echo $v['title']; ?>">
									</a>
								</div>
								<div class="media-body">
									<h4 class="media-heading">
										<a href="<?php echo $this->url('blog/blog_news',['id'=>$v['id']]);?>" title="<?php echo $v['title']; ?>" target='_self'>
											<?php echo $v['title']; ?>
										</a>
									</h4>
									...
									<p class="info">
										...
										<span>admin</span>
										<span><i class="icon wb-eye margin-right-5" aria-hidden="true"></i><?php echo $v['view']; ?>  </span>
									</p>
								</div>
							</div>
						</li>
		...
		<center><?php echo $pager; ?></center>
<div class="met-page-ajax-body visible-xs-block invisible" data-plugin="appear" data-animate="slide-bottom" data-repeat="false">
	<button type="button" class="btn btn-default btn-block btn-squared ladda-button" id="met-page-btn" data-style="slide-left" data-url="/muban/res013/323/blog/?lang=cn&class1=108&class2=0&class3=0&mbpagelist=1" data-page="1"><i class="icon wb-chevron-down margin-right-5" aria-hidden="true"></i>更多文章</button>
</div>
